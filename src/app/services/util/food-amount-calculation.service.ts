...
//     intermediatePortion = foodAmount.food.conversionRatios
...
//     if (!intermediatePortion) {
//       console.error('food portions:', foodAmount.food.conversionRatios);
...
//     const nutrientRefPortion = foodAmount.food.conversionRatios
